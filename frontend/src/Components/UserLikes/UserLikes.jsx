...
function UserLikes() {
    ...
    const getLikedVideos = useCallback(async () => {
        ...
        try {
            ...
            const errorMessage = error?.response?.data?.message || error.message || "An error occurred while fetching liked videos";
    ...
    // Remove video from UI immediately after unlike
