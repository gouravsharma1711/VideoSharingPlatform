...
const ChannelInfo = ({userData}) => {
    ...
    return (
        <div className="flex items-center justify-between p-4 bg-slate-700/30 rounded-2xl border border-gray-600/30">
            <div className="flex items-center gap-4">
                <div className="relative group">
                    ...
                    <img 
                        ...
                        className="relative w-12 h-12 rounded-full border-2 border-purple-500/30 hover:border-purple-500/60 transition-all duration-300 cursor-pointer hover:scale-110" 
                    />
                </div>
                <div>
                    <h3 className="font-bold text-white text-lg hover:text-purple-300 transition-colors duration-300 cursor-pointer">
                        {userData?.userName} 
                    </h3>
            ...
            <div className="flex items-center gap-3">
                ...
                <button
                    ...
                    className={`relative group overflow-hidden px-6 py-3 rounded-xl font-semibold text-sm transition-all duration-300 hover:scale-105 ${
                        isFollowing
